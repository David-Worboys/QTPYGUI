...
is a class of ```Action``` which probably should have been named 
```Event``` but for historical reasons that nomenclature is staying. 

The ```Action``` class has a number of very useful methods and properties, and 
